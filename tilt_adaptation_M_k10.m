...
set(h1,'PaperType','A4');
xx = axes('FontSize',16);
plot(M_s, rate_store(:,2),'b:d','LineWidth',2,'MarkerSize',15)
hold on
plot(M_s, rate_store(:,1),'k-*','LineWidth',2,'MarkerSize',10)
plot(M_s, rate_store(:,3),'r:s','LineWidth',2,'MarkerSize',15)
grid on
